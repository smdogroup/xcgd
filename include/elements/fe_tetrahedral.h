...
template <typename T>
class TetrahedralBasis final
    : public BasisBase<T, FEMesh<T, 3, 10>, TetrahedralQuadrature<T>> {
 private:
  using BasisBase = BasisBase<T, FEMesh<T, 3, 10>, TetrahedralQuadrature<T>>;
 ...
 public:
  ...
  TetrahedralBasis(Mesh& mesh, Quadrature& quadrature)
