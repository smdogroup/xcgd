...
class PhysicsBase {
 public:
   ...
   */
  virtual void residual(T weight, T x, A2D::Mat<T, spatial_dim, spatial_dim>& J,
   ...
   */
  virtual void jacobian_product(T weight, T x,
   ...
   */
  virtual void jacobian(T weight, T x, A2D::Mat<T, spatial_dim, spatial_dim>& J,
